...
sub = args.subject
project_dir = '/home/yueming/Data/THINGS-MEG'
...
concept_csv_file_path = os.path.join(project_dir,'Concept-specific/image_concept_index.csv')
csv_img_file_path = os.path.join(project_dir,"Image-specific/image_paths.csv")

origin_img_dir = os.path.join(project_dir,"../images_THINGS/object_images")
...
label=[[os.path.basename(path) for path in img_path_list_test]]
